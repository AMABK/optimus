import { Component, OnInit, forwardRef, ChangeDetectionStrategy, OnDestroy, AfterViewInit, Input, ViewChild, ElementRef, QueryList, EventEmitter, Inject, ChangeDetectorRef } from '@angular/core';
...
export class MatSelectSearchComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  @ViewChild('searchSelectInput', { static: false }) searchSelectInput;
